...
export const getPostList = (page: number): postType[] => {
  return postList.filter(
    (post: postType) => post.page < page && post.page > page - 9
  );
};

export const postList: postType[] = [
  { page: 1, title: "이상혁", content: "프론트엔드 개발자" },
  { page: 1, title: "상혁", content: "웹 퍼블리셔" },
  { page: 1, title: "LEE SangHyuk", content: "UI/UX 디자이너" },
  { page: 1, title: "이상", content: "React 개발자" },
  { page: 1, title: "SangHyuk", content: "JavaScript 마스터" },
  { page: 1, title: "이.상.혁", content: "프론트엔드 아키텍트" },
  { page: 1, title: "HYUK", content: "웹 인터페이스 개발자" },
  { page: 1, title: "이상혁 개발자", content: "TypeScript 전문가" },
  { page: 1, title: "L. SangHyuk", content: "프론트엔드 성능 최적화" },
  { page: 2, title: "상혁이", content: "웹 서비스 엔지니어" },
  { page: 2, title: "이상혁", content: "UI 컴포넌트 개발자" },
  { page: 2, title: "S. Hyuk", content: "프론트엔드 기술 리더" },
